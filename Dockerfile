...
# Copy built output, migrations, and production node_modules (with compiled better-sqlite3)
...
# App writes to ./.data (mount volume in production for SQLite persistence)
EXPOSE 3000
